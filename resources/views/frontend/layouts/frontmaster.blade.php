...
<html>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	...
	<!-- Flaticons  -->
	<link rel="stylesheet" href="{{asset('frontassets/fonts/flaticon/font/flaticon.css')}}">
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-7 col-md-9">
							<div id="colorlib-logo"><a href="{{ route('front.home') }}">Online Shopping Nepal</a></div>
						</div>
					...
					<div class="row">
						<div class="col-sm-12 text-left menu-1">
							<ul>
								<li class=@yield('home-active')><a href="{{route('front.home')}}">Home</a></li>
								<li class="has-dropdown 
								@yield('type-active')">
									<a href="{{route('types')}}">Men</a>
									<ul class="dropdown">
								...
								<li class="cart"><a href="{{ route('front.cart') }}"><i class="icon-shopping-cart"></i> Cart [

									@if(auth()->check())
									{{ App\Models\Cart::where('cart_by',auth()->user()->id)
            						->count()}}
								...
								<li class="cart"><a href="{{ route('login') }}"><i class="icon-user"></i> Login</a></li>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col partner-col text-center">
						<img src="{{asset('storage/frontimages/images/brand-1.jpg')}}" class="img-fluid" alt="Free html4 bootstrap 4 template">
					</div>
					<div class="col partner-col text-center">
						<img src="{{asset('storage/frontimages/images/brand-2.jpg')}}" class="img-fluid" alt="Free html4 bootstrap 4 template">
					</div>
					<div class="col partner-col text-center">
						<img src="{{asset('storage/frontimages/images/brand-3.jpg')}}" class="img-fluid" alt="Free html4 bootstrap 4 template">
					</div>
					<div class="col partner-col text-center">
						<img src="{{asset('storage/frontimages/images/brand-4.jpg')}}" class="img-fluid" alt="Free html4 bootstrap 4 template">
					</div>
					<div class="col partner-col text-center">
						<img src="{{asset('storage/frontimages/images/brand-5.jpg')}}" class="img-fluid" alt="Free html4 bootstrap 4 template">
					</div>
				</div>
			</div>
		</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></span> 
   ...
   <!-- jQuery easing -->
   <script src="{{asset('frontassets/js/jquery.easing.1.3.js')}}"></script>
	<!-- Waypoints -->
	...
	<script src="{{ asset('frontassets/js/magnific-popup-options.js') }}"></script>
	<!-- Date Picker -->
	<script src="{{ asset('frontassets/js/bootstrap-datepicker.js') }}"></script>
	<!-- Stellar Parallax -->
	<script src="{{ asset('frontassets/js/jquery.stellar.min.js') }}"></script>
	<!-- Main -->
