			...
			<div class="container">
				<div class="row row-pb-lg product-detail-wrap">
					<div class="col-sm-8">
						...
						<img src="{{ asset("storage/productimages/$row->photo") }}" alt="shoes" class="img-fluid">
					...
					@csrf	
                     ...
                     {{-- <div class="input-group mb-4"> --}}
                     	...
                     	<input type="hidden" name="photo_id" value="{{$photoSingleData->id}}">	
                  	...
                  	<div class="row">
	                  	<div class="col-sm-12 text-center">
									...
									<input type="submit" class="btn btn-primary btn-addtocart" value="Add to Cart">
								</div>
							</div>
